...
# Apply the scatter-two-nodes.yaml file to the cluster
echo "------------------- Running OSU Benchmark (scatter-two-nodes) -------------------" >> Results/Results.txt
kubectl apply -f scatter-two-nodes.yaml -n osu-benchmark
...
kubectl delete -f scatter-two-nodes.yaml -n osu-benchmark
